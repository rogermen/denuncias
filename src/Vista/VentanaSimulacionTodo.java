...
public class VentanaSimulacionTodo extends JFrame implements ActionListener{
  ...
  private JButton reportes = new JButton("Estadisticos");
    ...
    public VentanaSimulacionTodo(int gastos,int investigaciones,int llamadas,int siniestros) {
       // public VentanaSimulacionTodo();{
		this.gastos=gastos;
   ...
   // VentanaSimulacionTodo(int investigaciones) {
   ...
   reportes.setBounds(10, 25, 130, 35);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource().equals(Salir)){
	        ...
	        new VentanaSimulacionTodo(gastos,investigaciones,llamadas,siniestros);
