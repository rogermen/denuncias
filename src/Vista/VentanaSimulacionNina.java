...
public class VentanaSimulacionNina extends JFrame implements ActionListener{
  ...
  private JButton reportes = new JButton("Estadisticos");
    ...
    public VentanaSimulacionNina(int gastos,int investigaciones,int llamadas,int siniestros) {
       // public VentanaSimulacionNina();{
		this.gastos=gastos;
   ...
   // VentanaSimulacionNina(int investigaciones) {
   ...
   reportes.setBounds(10, 25, 130, 35);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource().equals(Salir)){
	        ...
	        new VentanaSimulacionNina(gastos,investigaciones,llamadas,siniestros);
