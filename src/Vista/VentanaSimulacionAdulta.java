...
public class VentanaSimulacionAdulta extends JFrame implements ActionListener{
  ...
  private JButton reportes = new JButton("Estadisticos");
    ...
    public VentanaSimulacionAdulta(int gastos,int investigaciones,int llamadas,int siniestros) {
       // public VentanaSimulacionAdulta();{
		this.gastos=gastos;
   ...
   // VentanaSimulacionAdulta(int investigaciones) {
   ...
   reportes.setBounds(10, 25, 130, 35);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource().equals(Salir)){
	        ...
	        new VentanaSimulacionAdulta(gastos,investigaciones,llamadas,siniestros);
